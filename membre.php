...
<?php
		...
		<div> <img id="background2" src="shaking-hands.jpg" alt="photo qui represente la connexion" width=88% height=600 /> </div>
		<div id=member>
			<div id=blocDeGauche2>
				<h1><span class="white">Déja client ?</span> Connexion</h1>
				<h3><span class="white">Accedez à votre compte</span></h3>
				<b><span class="white">Entrez ci-dessous vos informations de connexion :</b><br/><br/>
			...
			<h1><span class="white">Inscrivez vous</span></h1>
				<form method="POST" name="inscriptionform" autocomplete="on" action="<?php echo $_SERVER["PHP_SELF"] ?>">
					<span class="white">Civilité *</span><br /><SELECT name="choisissez" class="input" >
						<OPTION VALUE="M">M</OPTION>
						<OPTION VALUE="Mme">Mme</OPTION>
						<OPTION VALUE="Mlle">Mlle</OPTION>
					</SELECT><br /><br />
					<span class="white">Nom *</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<span class="white"> Prénom *</span><br><input type="text" name="fname" class="input" required />
					 &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="lname" class="input" required/><br /><br />
					<span></span><span class="white">Adresse *</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					 <span class="white">Code Postal *</span>  <br><input type="text" name="address" class="input" required />
					&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="cpostal" class="input" required /><br /><br />
					<span>Ville</span><span class="error">*</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<span class="white"> Pays *</span><br /><input type="text" name="ville" class="input" required />
					...
					<span class="white"> Email *</span><br /><input type="tel" name="numtel" class="input" autocomplete="off" required />
					...
					<span class="notice"><span class="black">*Champs obligatoires</span></span><br />
					<p class="notice">Conformément à la loi informatique et libertés du 6 janvier 1978, vous disposez d'un droit d'accès et 
					de rectifications aux données personnelles vous concernant. Il suffit d'écrire à Agence Style ou de vous inscrire.</p>

...
<html>
	...
	<script type="text/javascript">
      ...
      var canvas; // Canvas élément.
      var ctx; // Canvas contexte.
      ...
      function drawBall() {
        ...
        // Renvoyer la balle si elle atteint le sommet. 
        if (ballY + ballDY < 15) ballDY = -ballDY;
        // Si la balle atteint le sol verifier si elle touche le ping.

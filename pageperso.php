...
<html>
	<head>
		<?php
		$titre = 'Bienvenue sur Agence Style' ;
		include("header.php"); 
		?>
	</head>
	...
	<section class=center3>
		<div class=center><br/>
			...
			<fieldset class="bigfield">
				...
				<div id="contactPart">
				<h3 class="darkred">Arezki DJIBRI </h3>
				<b>Adresse :</b><br/>
	...
	<section class=center3>
		<div class=center><br/>
	L'accés est réservé aux personnes connectés. Veuillez vous connecter <a href="membre.php">ici</a>.
